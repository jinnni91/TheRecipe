...
const GET_MENU_CATEGORY_LIST = 'menu/GET_MENU_CATEGORY_LIST';
...
/* 메뉴 관련 액션 함수 */
export const { menu : { getMenulist, getSearchMenulist, getMenuCategoryList, getMenu, registMenu, modifyMenu, deleteMenu }} = createActions({
    [GET_MENULIST]: (res) => ({ menulist : res }),
    [GET_SEARCH_MENULIST]: (res) => ({ searchMenulist : res }),
    [GET_MENU_CATEGORY_LIST]: (res) => ({ menuCategoryList : res }),
...
const menuReducer = handleActions(
    {   
        ...
        [GET_MENU_CATEGORY_LIST]: (state, { payload }) => {
            return payload;
        },
